...
static struct dvfs dvfs_init[] = {
...
#ifdef CONFIG_TEGRA_OC
	CPU_DVFS("cpu", 1, 0, MHZ, 380, 380, 503, 503, 655, 655,  798,  798,  902,  902,  960,  1000, 1200, 1248, 1352, 1404, 1456, 1500),
	CPU_DVFS("cpu", 1, 1, MHZ, 216, 312, 456, 608, 760, 816,  798,  798,  950,  950,  1000, 1200, 1248, 1352, 1404, 1456, 1500),
#else
	...
	CORE_DVFS("sclk",     1, 1, KHZ, 123500, 159500, 207000, 240000, 240000, 264000, 277500, 277500, 277500, 277500),
