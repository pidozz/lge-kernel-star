...
#ifdef CONFIG_TEGRA_OC
	CPU_DVFS("cpu", 1, 0, MHZ, 380, 380, 503, 503, 655, 655,  798,  798,  902,  902,  960,  1000, 1200, 1248, 1352),
	CPU_DVFS("cpu", 1, 1, MHZ, 216, 312, 456, 608, 760, 816,  798,  798,  950,  950,  1000, 1200, 1248, 1352),
#else
