...
static struct dvfs dvfs_init[] = {
	...
	/* OC Cpu voltages (mV):   750, 775, 800, 825, 850, 875,  900,  925,  950,  975,  1000, 1025, 1125, 1150, 1125, 1225 */
#ifdef CONFIG_TEGRA_OC
	...
	CPU_DVFS("cpu", 1, 1, MHZ, 216, 312, 456, 608, 760, 816,  798,  798,  950,  950,  1000, 1200),
